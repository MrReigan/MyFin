// Данные для карточек товаров (скоро)
(function () {
  const main_soon = [
      {
      level: "Начинающий",
      ...
      rating: "0.0",
      gone: "0",
      img: "./images/card-img/soon.png",
      title: "Деньги под контролем",
      info: "6 лекций • 0 аудио • 0 видео",
      id: "2", 
      a: "#",
    },
    {
      ...
      gone: "0",
      img: "./images/card-img/soon.png",
      title: "На шаг вперёд: сбережения, цели, рост",
    ...
    // Контейнер для карточек товаров (скоро)
    const main_soonContainer = document.getElementById("main_soon-container");
    ...
    // Генерация карточек товаров (скоро)
    let main_soonHTML = "";
    
    main_soon.forEach(({ level, price, rating, gone, img, title, info, id }) => {
      main_soonHTML += `
    ...
    main_soonContainer.innerHTML = main_soonHTML;
