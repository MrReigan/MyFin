// Данные для карточек товаров (хиты)
(function () {
  const sales = [
    {
      level: "Начинающий",
  ...
  // Контейнер для карточек товаров (хиты)
  ...
  // Генерация карточек товаров (хиты)
  let salesHTML = "";

  sales.forEach(({ level, price, rating, gone, img, title, info, id, a }) => {
    salesHTML += `
