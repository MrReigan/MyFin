// Данные для избранного (те же, что и all_curse)
const in_plan = [
  // Хиты
  {
    level: "Продвинутый",
...

  {
    ...
    rating: "4.8",
    gone: "150",
    img: "/images/card-img/curse-1.png",
    title: "Как инвестировать в биотех",
    info: "8 лекций • 6 аудио • 5 видео",
    id: "4",
    a: "/curses.html",
  },

  {
    ...
    rating: "5.0",
    gone: "250",
    img: "/images/card-img/curse-2.png",
    title: "Начинающий инвестор",
    info: "7 лекций • 3 аудио • 4 видео",
    id: "5",
    a: "/novice-investor.html",
  },
...

  {
    ...
    info: "12 лекций • 10 аудио • 8 видео",
    id: "13", 
    a: "/curses.html",
  },

  {
    ...
    gone: "150",
    img: "/images/card-img/curse-3.png",
    title: "Трейдинг на бирже",
    info: "9 лекций • 7 аудио • 5 видео",
    id: "14",
    a: "/curses.html",
  }
];
...
function renderFavorites() {
  ...
  if (favorites.length > 0) {
    const favoriteProducts = in_plan.filter((product) =>
      favorites.includes(product.id)
    );

    favoriteProducts.forEach(
      ({ level, price, rating, gone, img, title, info, id, a }) => {
        favoritesHTML += `
    ...
    favoritesHTML = "<p class='in-plan-no'>У вас пока нет добавленных курсов</p>";
  }
  ...
  favoriteButtons.forEach((button) => {
    ...
    button.addEventListener("click", () => {
      toggleFavorite(productId); // Добавляем/удаляем товар из избранного
      updateButtonState(button, productId); // Обновляем состояние кнопки
      renderFavorites(); // Перерисовываем избранные товары
    });
  });
}

// Первоначальная отрисовка избранных товаров
renderFavorites();

// Обработчик переключения на таб с избранными товарами
